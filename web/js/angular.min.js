...
(c=a.indexOf(Ed))&&(a=a.replace(Ed,""));0<(e=a.search(/e/i))?(0>c&&(c=e),c+=+a.slice(e+1),a=a.substring(0,e)):0>c&&(c=a.length);for(e=0;a.charAt(e)==jc;e++);if(e==(g=a.length))d=[0],c=1;else{for(g--;a.charAt(g)==jc;)g--;c-=e;d=[];for(f=0;e<=g;e++,f++)d[f]=+a.charAt(e)}c>Fd&&(d=d.splice(0,Fd-1),b=c-1,c=1);return{d:d,e:b,indexQuestion:c}}function ug(a, b, d, c){var e=a.d,f=e.length-a.indexQuestion;b=y(b)?Math.min(Math.max(d,f),c):+b;d=b+a.indexQuestion;c=e[d];if(0<d){e.splice(Math.max(a.indexQuestion,d));for(var g=d; g<e.length; g++)e[g]=0}else for(f=
Math.max(0,f),a.indexQuestion=1,e.length=Math.max(1,d=b+1),e[0]=0,g=1; g<d; g++)e[g]=0;if(5<=c)if(0>d-1){for(c=0; c>d; c--)e.unshift(0),a.indexQuestion++;e.unshift(1);a.indexQuestion++}else e[d-1]++;for(; f<Math.max(0,b); f++)e.push(0);if(b=e.reduceRight(function(a, b, c, d){b+=a;d[c]=b%10;return Math.floor(b/10)},0))e.unshift(b),a.indexQuestion++}function Dd(a, b, d, c, e){if(!F(a)&&!Q(a)||isNaN(a))return"";var f=!isFinite(a),g=!1,h=Math.abs(a)+"",k="";if(f)k="\u221e";else{g=tg(h);ug(g,e,b.minFrac,b.maxFrac);k=g.d;h=g.indexQuestion;e=g.e;f=[];for(g=k.reduce(function(a,
